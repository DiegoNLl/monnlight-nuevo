...
const heroLearButton = document.querySelector('.hero__learn-button');
const heroStars = document.querySelector('.hero__star-image');
...
document.addEventListener('scroll', () => {
  heroTitle.style.transform = `translate(-${scrollY * 1.25}px, ${scrollX * 0.25}px)`;
  heroLearButton.style.transform = `translate (-50%, ${scrollY * 0.125}px)`;
